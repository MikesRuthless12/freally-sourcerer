...
// real freally-indexd implementation behind these types without touching
// the UI.

// ---- query.parse (real, routed to freally-query::parse_to_report) ----
...
export interface ContextMenuConfig {
  ...
  reveal_in_freally: ContextMenuEntry;
  send_to_freally: ContextMenuEntry;
}
