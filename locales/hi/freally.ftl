...
toast-search-failed = खोज विफल: { $error }
toast-settings-save-failed = सेटिंग्स सहेजी नहीं जा सकीं: { $error }
toast-settings-reset-failed = डिफ़ॉल्ट पुनर्स्थापित नहीं किए जा सके: { $error }
toast-index-root-failed = { $path } को इंडेक्स में नहीं जोड़ा जा सका: { $error }
menu-help-report-bug = बग की रिपोर्ट करें…
bugreport-title = बग की रिपोर्ट करें
bugreport-crash-notice = पिछली बार चलने पर Freally Sourcerer अप्रत्याशित रूप से बंद हो गया था। आप इसके बारे में एक गुमनाम रिपोर्ट भेज सकते हैं।
bugreport-what-happened = क्या हुआ?
bugreport-placeholder = गड़बड़ी होने पर आप क्या कर रहे थे?
bugreport-include-crash = नीचे दिए गए क्रैश विवरण शामिल करें
bugreport-exact-text = ठीक यही भेजा जाएगा
bugreport-privacy = कुछ भी स्वतः नहीं भेजा जाता। एक पहले से भरा ड्राफ़्ट खुलेगा — आप उसे पढ़ें और स्वयं भेजें। रिपोर्ट में केवल ऐप संस्करण और आपका OS होता है; आपका होम फ़ोल्डर और उपयोगकर्ता नाम हटा दिए जाते हैं।
bugreport-github = GitHub पर समस्या खोलें
bugreport-gmail = Gmail में खोलें
bugreport-email = मेरे ईमेल ऐप में खोलें
bugreport-copy = रिपोर्ट कॉपी करें
bugreport-copied = कॉपी हो गया।
bugreport-discard-crash = यह क्रैश रिपोर्ट हटाएँ
bugreport-opened = ड्राफ़्ट खुला है। इसे पढ़ें, फिर स्वयं भेजें।
bugreport-failed = ड्राफ़्ट नहीं खोला जा सका: { $error }
logs-crash-drills = क्रैश-रिपोर्ट अभ्यास
logs-simulate-crash = क्रैश रिपोर्ट का अनुकरण करें
logs-force-crash = परीक्षण क्रैश बाध्य करें और बाहर निकलें
updates-check-now = अभी अपडेट जाँचें
updates-checking = जाँच हो रही है…
updates-last-checked = पिछली जाँच
updates-never-checked = कभी नहीं
updates-current = आप नवीनतम रिलीज़ ({ $current }) चला रहे हैं।
updates-available = संस्करण { $version } उपलब्ध है। आप { $current } चला रहे हैं।
updates-confirm-title = अपडेट इंस्टॉल करें
updates-confirm-body = Freally Sourcerer { $version } उपलब्ध है।\n\nआप { $current } चला रहे हैं। क्या आप Freally Sourcerer बंद करके नया संस्करण अभी इंस्टॉल करना चाहते हैं?
updates-confirm-yes = हाँ, इंस्टॉल करें
updates-confirm-no = अभी नहीं
updates-installing = { $version } डाउनलोड और इंस्टॉल हो रहा है… Freally Sourcerer बंद हो जाएगा।
updates-failed = अपडेट विफल: { $error }
updates-notes-heading = नया क्या है
