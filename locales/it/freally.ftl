...
toast-search-failed = Ricerca non riuscita: { $error }
toast-settings-save-failed = Impossibile salvare le impostazioni: { $error }
toast-settings-reset-failed = Impossibile ripristinare i valori predefiniti: { $error }
toast-index-root-failed = Impossibile aggiungere { $path } all’indice: { $error }
menu-help-report-bug = Segnala un problema…
bugreport-title = Segnala un problema
bugreport-crash-notice = Freally Sourcerer si è chiuso in modo imprevisto all’ultimo avvio. Puoi inviare una segnalazione anonima in merito.
bugreport-what-happened = Che cosa è successo?
bugreport-placeholder = Che cosa stavi facendo quando è andato storto?
bugreport-include-crash = Includi i dettagli dell’arresto qui sotto
bugreport-exact-text = Questo è esattamente ciò che verrà inviato
bugreport-privacy = Non viene inviato nulla automaticamente. Si apre una bozza già compilata: la leggi e la invii tu. La segnalazione contiene solo la versione dell’app e il tuo sistema operativo; la cartella home e il nome utente vengono rimossi.
bugreport-github = Apri una issue su GitHub
bugreport-gmail = Apri in Gmail
bugreport-email = Apri nella mia app di posta
bugreport-copy = Copia segnalazione
bugreport-copied = Copiato.
bugreport-discard-crash = Elimina questa segnalazione di arresto
bugreport-opened = È aperta una bozza. Leggila, poi inviala tu.
bugreport-failed = Impossibile aprire la bozza: { $error }
logs-crash-drills = Prove di segnalazione arresto
logs-simulate-crash = Simula una segnalazione di arresto
logs-force-crash = Forza un arresto di prova ed esci
updates-check-now = Cerca aggiornamenti ora
updates-checking = Controllo…
updates-last-checked = Ultimo controllo
updates-never-checked = Mai
updates-current = Stai usando l’ultima versione ({ $current }).
updates-available = La versione { $version } è disponibile. Stai usando { $current }.
updates-confirm-title = Installa aggiornamento
updates-confirm-body = Freally Sourcerer { $version } è disponibile.\n\nStai usando { $current }. Vuoi chiudere Freally Sourcerer e installare la nuova versione adesso?
updates-confirm-yes = Sì, installa
updates-confirm-no = Non ora
updates-installing = Download e installazione di { $version }… Freally Sourcerer si chiuderà.
updates-failed = Aggiornamento non riuscito: { $error }
updates-notes-heading = Novità
...
menu-search-match-phonetic = Corrispondenza fonetica CJK

# SRC-M13 — Index Health panel + rebuild advisor
menu-tools-index-health = Stato dell’indice…
health-title = Stato dell’indice
health-loading = Lettura dello stato dell’indice…
health-all-good = Tutte le posizioni monitorate sono aggiornate.
health-no-watched-roots = Nessuna cartella è ancora indicizzata.
health-col-volume = Posizione
health-col-status = Stato
health-col-lag = Ritardo
health-col-last-event = Ultima modifica
health-col-applied = Applicati
health-col-dropped = Persi
health-col-queue = Coda
health-status-live = In diretta
health-status-scan-only = Solo scansione
health-lag-value = { $last } ms (picco { $max } ms)
health-no-events-yet = Ancora nessuna modifica
health-never = Mai
health-ago = { $secs } s fa
health-legend = Il ritardo è il tempo tra una modifica sul disco e la sua comparsa nei risultati. «Applicati» conta gli eventi indicizzati, con gli eventi uniti tra parentesi.
health-extraction-untracked = L’arretrato di estrazione dei contenuti non è ancora monitorato.
health-extraction-backlog = Arretrato di estrazione dei contenuti: { $count }
health-fix-rebuild = Ricostruisci indice
health-advice-journal-stream-reset = Il sistema operativo ha scartato il flusso di modifiche su { $root }. Le modifiche avvenute nel frattempo mancano dall’indice: una ricostruzione le ripristina.
health-advice-events-dropped = { $count } modifiche su { $root } sono arrivate più velocemente di quanto potessero essere indicizzate e sono andate perse. Una ricostruzione le ripristina.
...
menu-edit-bulk-rename = Rinomina…
rename-title = Rinomina { $count } selezionati
rename-find = Trova
rename-replace = Sostituisci con
rename-use-regex = Espressione regolare
rename-ignore-case = Ignora maiuscole
rename-part = Applica a
rename-part-stem = Nome senza estensione
rename-part-full = Nome completo
rename-case = Maiuscole
rename-case-none = Invariate
rename-case-lower = minuscolo
rename-case-upper = MAIUSCOLO
rename-case-title = Iniziali Maiuscole
rename-counter-start = Contatore da
rename-hint = Usa { "{" }n{ "}" } per un contatore e { "{" }n:03{ "}" } per riempirlo. Con le espressioni regolari, $1 inserisce un gruppo.
rename-col-before = Prima
rename-col-after = Dopo
rename-col-status = Stato
rename-status-ok = Verrà rinominato
rename-status-unchanged = Invariato
rename-status-invalid = Nome non valido
rename-status-collision = Due file avrebbero lo stesso nome
rename-status-exists = Un file ha già questo nome
rename-invalid-empty = Il nome sarebbe vuoto
rename-invalid-path-separator = Il nome non può contenere separatori di cartella
rename-invalid-dot-name = Il nome non può essere . o ..
rename-invalid-forbidden-character = Il nome contiene un carattere non consentito
rename-invalid-reserved-name = Il nome è riservato dal sistema operativo
rename-invalid-bad-pattern = Il criterio di ricerca non è valido
rename-summary = Verranno rinominati { $count } file.
rename-blocked = Correggi le righe evidenziate prima di rinominare. Fino ad allora non cambia nulla.
rename-apply = Rinomina
rename-toast-done = { $count } file rinominati
rename-nothing-selected = Seleziona prima alcuni risultati.
ops-toast-undone = Annullato — { $count } file ripristinati
ops-toast-redone = Ripetuto — { $count } file rinominati di nuovo
about-portable-on = La modalità portatile è attiva
about-portable-hint = Indice, impostazioni e segnalibri restano in questa cartella. Nulla viene scritto su questo computer.
settings-results-natural-sort = Ordinamento naturale (file2 prima di file10)
menu-search-ignore-punctuation = Ignora la punteggiatura
menu-search-ignore-whitespace = Ignora gli spazi
regex-builder-title = Costruttore di espressioni regolari
regex-builder-placeholder = Scrivi un pattern, es. ^report-\d+
regex-builder-match-count = { $matched } su { $total } nomi mostrati corrispondono
regex-builder-no-results = Fai prima una ricerca: il costruttore prova il pattern sui nomi a schermo.
regex-builder-cheatsheet = Riepilogo
regex-builder-flavor-note = Sintassi Rust. Niente retroriferimenti né lookaround: il motore di ricerca non li supporta.
regex-builder-use = Usa questo pattern
regex-cheat-any = Un carattere qualsiasi
regex-cheat-classes = Cifra, carattere di parola, spazio
regex-cheat-set = Uno dell’insieme, o nessuno dell’insieme
regex-cheat-repeat = Zero o più, uno o più, facoltativo
regex-cheat-count = Esattamente, almeno, o un intervallo
regex-cheat-anchor = Inizio e fine del nome
regex-cheat-alt = L’uno o l’altro
regex-cheat-inline-flag = Ignora maiuscole da qui in poi
regex-cheat-noncapturing = Raggruppa senza catturare
regex-cheat-escape = Fai l’escape di un carattere speciale
quicklook-title = Occhiata
quicklook-position = { $at } di { $total }
quicklook-hint = Le frecce scorrono i risultati · Spazio o Esc chiude
quicklook-open-native = Apri in Occhiata di macOS
menu-view-sidebar = Barra laterale
sidebar-title = Barra laterale
sidebar-bookmarks = Segnalibri
sidebar-filters = Filtri
sidebar-volumes = Volumi
sidebar-recent = Ricerche recenti
sidebar-no-bookmarks = Ancora nessun segnalibro
sidebar-no-volumes = Nessun volume indicizzato
sidebar-no-recent = Ancora niente
sidebar-clear-recent = Svuota
menu-tools-permission-health = Stato dei permessi…
permissions-title = Stato dei permessi
permissions-all-clear = Tutto ciò che hai chiesto di indicizzare era leggibile.
permissions-summary = { $denied } cartelle non sono state lette perché l'accesso è stato negato e { $other } non sono riuscite per altri motivi. I file al loro interno non sono nell'indice e non compariranno nei risultati.
permissions-truncated = Altre { $dropped } sono state conteggiate ma non elencate.
permissions-how-to-fix = Come risolvere
permissions-by-volume = Dove
permissions-group-counts = { $denied } negate · { $other } altre
permissions-macos-granted = Freally ha già l'accesso completo al disco. Le cartelle qui sotto sono protette da altro: controlla proprietario e permessi.
permissions-macos-steps = macOS protegge queste cartelle finché non concedi l'accesso completo al disco. Apri Privacy e sicurezza → Accesso completo al disco, attiva Freally, chiudi e riapri Freally e riesegui la scansione.
permissions-macos-open-settings = Apri le impostazioni Accesso completo al disco
permissions-macos-undetermined = Freally non ha potuto stabilire se l'accesso completo al disco è già concesso, quindi il problema potrebbe essere un altro.
permissions-linux-steps = Il tuo utente non può leggere questi percorsi. Controlla proprietario e modo della cartella, oppure monta il filesystem con permessi attraversabili dal tuo account. Indicizzare percorsi di sistema può richiedere privilegi elevati per il daemon.
permissions-windows-steps = Una regola di accesso di Windows nega il tuo account. Apri Proprietà → Sicurezza della cartella per vedere quale regola si applica, oppure esegui il servizio di indicizzazione come utente autorizzato a leggerla.
permissions-generic-steps = Il sistema operativo ha rifiutato di leggere questi percorsi. Controlla i permessi.
status-paths-skipped = { $count } cartelle saltate
media-open-externally = Apri nel lettore di sistema
media-play-pause = Riproduci o metti in pausa
media-seek = Cerca
media-loop = Ripeti
media-volume = Volume
