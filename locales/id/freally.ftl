...
toast-search-failed = Pencarian gagal: { $error }
toast-settings-save-failed = Tidak dapat menyimpan pengaturan: { $error }
toast-settings-reset-failed = Tidak dapat memulihkan setelan bawaan: { $error }
toast-index-root-failed = Tidak dapat menambahkan { $path } ke indeks: { $error }
menu-help-report-bug = Laporkan Bug…
bugreport-title = Laporkan bug
bugreport-crash-notice = Freally Sourcerer tertutup tak terduga saat terakhir dijalankan. Anda dapat mengirim laporan anonim tentang hal itu.
bugreport-what-happened = Apa yang terjadi?
bugreport-placeholder = Apa yang sedang Anda lakukan saat terjadi masalah?
bugreport-include-crash = Sertakan detail kerusakan di bawah
bugreport-exact-text = Persis inilah yang akan dikirim
bugreport-privacy = Tidak ada yang dikirim otomatis. Ini membuka draf yang sudah terisi — Anda membacanya dan mengirimnya sendiri. Laporan hanya memuat versi aplikasi dan OS Anda; folder beranda dan nama pengguna dihapus.
bugreport-github = Buka isu GitHub
bugreport-gmail = Buka di Gmail
bugreport-email = Buka di aplikasi email saya
bugreport-copy = Salin laporan
bugreport-copied = Tersalin.
bugreport-discard-crash = Buang laporan kerusakan ini
bugreport-opened = Draf sudah terbuka. Bacalah, lalu kirim sendiri.
bugreport-failed = Tidak dapat membuka draf: { $error }
logs-crash-drills = Latihan laporan kerusakan
logs-simulate-crash = Simulasikan laporan kerusakan
logs-force-crash = Paksa kerusakan uji dan keluar
updates-check-now = Periksa pembaruan sekarang
updates-checking = Memeriksa…
updates-last-checked = Terakhir diperiksa
updates-never-checked = Belum pernah
updates-current = Anda menjalankan rilis terbaru ({ $current }).
updates-available = Versi { $version } tersedia. Anda menjalankan { $current }.
updates-confirm-title = Pasang pembaruan
updates-confirm-body = Freally Sourcerer { $version } tersedia.\n\nAnda menjalankan { $current }. Tutup Freally Sourcerer dan pasang versi baru sekarang?
updates-confirm-yes = Ya, pasang
updates-confirm-no = Nanti saja
updates-installing = Mengunduh dan memasang { $version }… Freally Sourcerer akan ditutup.
updates-failed = Pembaruan gagal: { $error }
updates-notes-heading = Yang baru
...
menu-search-match-phonetic = Cocokkan fonetik CJK

# SRC-M13 — Index Health panel + rebuild advisor
menu-tools-index-health = Kesehatan Indeks…
health-title = Kesehatan indeks
health-loading = Membaca kesehatan indeks…
health-all-good = Semua lokasi yang dipantau sudah mutakhir.
health-no-watched-roots = Belum ada folder yang diindeks.
health-col-volume = Lokasi
health-col-status = Status
health-col-lag = Jeda
health-col-last-event = Perubahan terakhir
health-col-applied = Diterapkan
health-col-dropped = Terbuang
health-col-queue = Antrean
health-status-live = Langsung
health-status-scan-only = Hanya pindai
health-lag-value = { $last } ms (puncak { $max } ms)
health-no-events-yet = Belum ada perubahan
health-never = Tidak pernah
health-ago = { $secs } dtk lalu
health-legend = Jeda adalah waktu dari sebuah perubahan di disk sampai muncul di hasil. “Diterapkan” menghitung peristiwa yang diindeks, peristiwa yang digabung dalam tanda kurung.
health-extraction-untracked = Tumpukan ekstraksi konten belum dilacak.
health-extraction-backlog = Tumpukan ekstraksi konten: { $count }
health-fix-rebuild = Bangun ulang indeks
health-advice-journal-stream-reset = Sistem operasi membuang aliran perubahan pada { $root }. Perubahan yang terjadi sementara itu tidak ada di indeks — membangun ulang akan memulihkannya.
health-advice-events-dropped = { $count } perubahan pada { $root } datang lebih cepat daripada yang dapat diindeks dan terbuang. Membangun ulang akan memulihkannya.
...
menu-edit-bulk-rename = Ganti nama…
rename-title = Ganti nama { $count } terpilih
rename-find = Cari
rename-replace = Ganti dengan
rename-use-regex = Ekspresi reguler
rename-ignore-case = Abaikan huruf besar/kecil
rename-part = Terapkan ke
rename-part-stem = Nama tanpa ekstensi
rename-part-full = Seluruh nama berkas
rename-case = Huruf
rename-case-none = Tidak berubah
rename-case-lower = huruf kecil
rename-case-upper = HURUF BESAR
rename-case-title = Huruf Awal Besar
rename-counter-start = Penghitung dari
rename-hint = Gunakan { "{" }n{ "}" } untuk penghitung dan { "{" }n:03{ "}" } untuk melengkapinya. Dengan ekspresi reguler, $1 menyisipkan sebuah grup.
rename-col-before = Sebelum
rename-col-after = Sesudah
rename-col-status = Status
rename-status-ok = Akan diganti
rename-status-unchanged = Tidak berubah
rename-status-invalid = Nama tidak valid
rename-status-collision = Dua berkas akan bernama sama
rename-status-exists = Sudah ada berkas dengan nama ini
rename-invalid-empty = Nama akan kosong
rename-invalid-path-separator = Nama tidak boleh memuat pemisah folder
rename-invalid-dot-name = Nama tidak boleh . atau ..
rename-invalid-forbidden-character = Nama memuat karakter yang tidak diizinkan
rename-invalid-reserved-name = Nama dicadangkan oleh sistem operasi
rename-invalid-bad-pattern = Pola pencarian tidak valid
rename-summary = { $count } berkas akan diganti namanya.
rename-blocked = Perbaiki baris yang ditandai sebelum mengganti nama. Sampai itu, tidak ada yang diubah.
rename-apply = Ganti nama
rename-toast-done = { $count } berkas diganti namanya
rename-nothing-selected = Pilih beberapa hasil dahulu.
ops-toast-undone = Diurungkan — { $count } berkas dikembalikan
ops-toast-redone = Diulangi — { $count } berkas diganti nama lagi
about-portable-on = Mode portabel aktif
about-portable-hint = Indeks, pengaturan, dan markah Anda tetap di folder ini. Tidak ada yang ditulis ke komputer ini.
settings-results-natural-sort = Pengurutan alami (file2 sebelum file10)
menu-search-ignore-punctuation = Abaikan tanda baca
menu-search-ignore-whitespace = Abaikan spasi
regex-builder-title = Pembuat ekspresi reguler
regex-builder-placeholder = Ketik pola, mis. ^laporan-\d+
regex-builder-match-count = { $matched } dari { $total } nama yang tampil cocok
regex-builder-no-results = Cari dulu — pembuat menguji pola Anda pada nama yang tampil di layar.
regex-builder-cheatsheet = Contekan
regex-builder-flavor-note = Sintaks Rust. Tanpa referensi balik dan tanpa lookaround — mesin pencari tidak mendukungnya.
regex-builder-use = Gunakan pola ini
regex-cheat-any = Satu karakter apa pun
regex-cheat-classes = Angka, karakter kata, spasi
regex-cheat-set = Salah satu dari himpunan, atau bukan salah satunya
regex-cheat-repeat = Nol atau lebih, satu atau lebih, opsional
regex-cheat-count = Tepat, sekurangnya, atau rentang
regex-cheat-anchor = Awal dan akhir nama
regex-cheat-alt = Salah satu dari dua
regex-cheat-inline-flag = Abaikan huruf besar/kecil mulai di sini
regex-cheat-noncapturing = Kelompokkan tanpa menangkap
regex-cheat-escape = Escape karakter khusus
quicklook-title = Lihat Cepat
quicklook-position = { $at } dari { $total }
quicklook-hint = Tombol panah menelusuri hasil · Spasi atau Esc menutup
quicklook-open-native = Buka di Lihat Cepat macOS
menu-view-sidebar = Bilah sisi
sidebar-title = Bilah sisi
sidebar-bookmarks = Markah
sidebar-filters = Filter
sidebar-volumes = Volume
sidebar-recent = Pencarian terbaru
sidebar-no-bookmarks = Belum ada markah
sidebar-no-volumes = Belum ada volume terindeks
sidebar-no-recent = Belum ada
sidebar-clear-recent = Hapus
menu-tools-permission-health = Status izin…
permissions-title = Status izin
permissions-all-clear = Semua yang Anda minta diindeks dapat dibaca.
permissions-summary = { $denied } folder tidak dapat dibaca karena akses ditolak, dan { $other } gagal karena alasan lain. Berkas di dalamnya tidak ada di indeks dan tidak akan muncul di hasil.
permissions-truncated = { $dropped } lainnya dihitung tetapi tidak didaftar.
permissions-how-to-fix = Cara memperbaikinya
permissions-by-volume = Di mana
permissions-group-counts = { $denied } ditolak · { $other } lainnya
permissions-macos-granted = Freally sudah memiliki Akses Disk Penuh. Folder di bawah dilindungi oleh hal lain — periksa kepemilikan dan izinnya.
permissions-macos-steps = macOS melindungi folder ini sampai Anda memberikan Akses Disk Penuh. Buka Privasi & Keamanan → Akses Disk Penuh, aktifkan Freally, tutup lalu buka kembali Freally dan pindai ulang.
permissions-macos-open-settings = Buka pengaturan Akses Disk Penuh
permissions-macos-undetermined = Freally tidak dapat memastikan apakah Akses Disk Penuh sudah diberikan, jadi mungkin ini bukan masalahnya.
permissions-linux-steps = Pengguna Anda tidak dapat membaca jalur ini. Periksa pemilik dan mode folder, atau kaitkan sistem berkas dengan izin yang dapat dilalui akun Anda. Mengindeks jalur sistem mungkin memerlukan daemon berjalan dengan hak istimewa lebih tinggi.
permissions-windows-steps = Aturan akses Windows menolak akun Anda. Buka Properti → Keamanan folder untuk melihat aturan yang berlaku, atau jalankan layanan indeks sebagai pengguna yang dapat membacanya.
permissions-generic-steps = Sistem operasi menolak membaca jalur ini. Periksa izinnya.
status-paths-skipped = { $count } folder dilewati
media-open-externally = Buka di pemutar sistem
media-play-pause = Putar atau jeda
media-seek = Cari
media-loop = Ulang
media-volume = Volume
