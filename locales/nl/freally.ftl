...
toast-search-failed = Zoeken mislukt: { $error }
toast-settings-save-failed = Kan instellingen niet opslaan: { $error }
toast-settings-reset-failed = Kan standaardwaarden niet herstellen: { $error }
toast-index-root-failed = Kan { $path } niet aan de index toevoegen: { $error }
menu-help-report-bug = Een bug melden…
bugreport-title = Een bug melden
bugreport-crash-notice = Freally Sourcerer is de vorige keer onverwacht afgesloten. U kunt hierover een anoniem rapport sturen.
bugreport-what-happened = Wat is er gebeurd?
bugreport-placeholder = Wat was u aan het doen toen het misging?
bugreport-include-crash = De crashdetails hieronder meesturen
bugreport-exact-text = Dit is precies wat er verstuurd wordt
bugreport-privacy = Er wordt niets automatisch verstuurd. Er opent een vooringevuld concept — u leest het en verstuurt het zelf. Het rapport bevat alleen de app-versie en uw besturingssysteem; uw thuismap en gebruikersnaam worden verwijderd.
bugreport-github = Een GitHub-issue openen
bugreport-gmail = Openen in Gmail
bugreport-email = Openen in mijn e-mailapp
bugreport-copy = Rapport kopiëren
bugreport-copied = Gekopieerd.
bugreport-discard-crash = Dit crashrapport weggooien
bugreport-opened = Er staat een concept open. Lees het en verstuur het zelf.
bugreport-failed = Kan het concept niet openen: { $error }
logs-crash-drills = Crashrapport-oefeningen
logs-simulate-crash = Een crashrapport simuleren
logs-force-crash = Een testcrash forceren en afsluiten
updates-check-now = Nu op updates controleren
updates-checking = Bezig met controleren…
updates-last-checked = Laatst gecontroleerd
updates-never-checked = Nooit
updates-current = U gebruikt de nieuwste release ({ $current }).
updates-available = Versie { $version } is beschikbaar. U gebruikt { $current }.
updates-confirm-title = Update installeren
updates-confirm-body = Freally Sourcerer { $version } is beschikbaar.\n\nU gebruikt { $current }. Wilt u Freally Sourcerer sluiten en de nieuwe versie nu installeren?
updates-confirm-yes = Ja, installeren
updates-confirm-no = Nu niet
updates-installing = { $version } wordt gedownload en geïnstalleerd… Freally Sourcerer wordt gesloten.
updates-failed = Bijwerken mislukt: { $error }
updates-notes-heading = Wat is er nieuw
...
menu-tools-index-health = Indexstatus…
health-title = Indexstatus
health-loading = Indexstatus wordt gelezen…
health-all-good = Alle bewaakte locaties zijn bijgewerkt.
health-no-watched-roots = Er worden nog geen mappen geïndexeerd.
health-col-volume = Locatie
health-col-status = Status
health-col-lag = Vertraging
health-col-last-event = Laatste wijziging
health-col-applied = Toegepast
health-col-dropped = Verloren
health-col-queue = Wachtrij
health-status-live = Live
health-status-scan-only = Alleen scan
health-lag-value = { $last } ms (piek { $max } ms)
health-no-events-yet = Nog geen wijzigingen
health-never = Nooit
health-ago = { $secs } s geleden
health-legend = De vertraging is de tijd tussen een wijziging op schijf en het verschijnen ervan in de resultaten. ‘Toegepast’ telt geïndexeerde gebeurtenissen, samengevoegde gebeurtenissen tussen haakjes.
health-extraction-untracked = De achterstand bij inhoudsextractie wordt nog niet bijgehouden.
health-extraction-backlog = Achterstand bij inhoudsextractie: { $count }
health-fix-rebuild = Index opnieuw opbouwen
health-advice-journal-stream-reset = Het besturingssysteem heeft de wijzigingsstroom op { $root } weggegooid. Wijzigingen van tussentijds ontbreken in de index — opnieuw opbouwen herstelt ze.
health-advice-events-dropped = { $count } wijzigingen op { $root } kwamen sneller binnen dan ze geïndexeerd konden worden en zijn verloren. Opnieuw opbouwen herstelt ze.
...
menu-edit-bulk-rename = Hernoemen…
rename-title = { $count } geselecteerde hernoemen
rename-find = Zoeken
rename-replace = Vervangen door
rename-use-regex = Reguliere expressie
rename-ignore-case = Hoofdletters negeren
rename-part = Toepassen op
rename-part-stem = Naam zonder extensie
rename-part-full = Hele bestandsnaam
rename-case = Hoofdlettergebruik
rename-case-none = Ongewijzigd
rename-case-lower = kleine letters
rename-case-upper = HOOFDLETTERS
rename-case-title = Beginletters Hoofdletter
rename-counter-start = Teller vanaf
rename-hint = Gebruik { "{" }n{ "}" } voor een teller en { "{" }n:03{ "}" } om aan te vullen. Met reguliere expressies voegt $1 een groep in.
rename-col-before = Voor
rename-col-after = Na
rename-col-status = Status
rename-status-ok = Wordt hernoemd
rename-status-unchanged = Ongewijzigd
rename-status-invalid = Ongeldige naam
rename-status-collision = Twee bestanden zouden dezelfde naam krijgen
rename-status-exists = Een bestand heeft deze naam al
rename-invalid-empty = Naam zou leeg zijn
rename-invalid-path-separator = Naam mag geen mapscheidingsteken bevatten
rename-invalid-dot-name = Naam mag niet . of .. zijn
rename-invalid-forbidden-character = Naam bevat een teken dat niet is toegestaan
rename-invalid-reserved-name = Naam is gereserveerd door het besturingssysteem
rename-invalid-bad-pattern = Het zoekpatroon is ongeldig
rename-summary = { $count } bestanden worden hernoemd.
rename-blocked = Los de gemarkeerde rijen op voordat u hernoemt. Tot dan wordt er niets gewijzigd.
rename-apply = Hernoemen
rename-toast-done = { $count } bestanden hernoemd
rename-nothing-selected = Selecteer eerst enkele resultaten.
ops-toast-undone = Ongedaan gemaakt — { $count } bestanden teruggezet
ops-toast-redone = Opnieuw — { $count } bestanden opnieuw hernoemd
about-portable-on = Draagbare modus staat aan
about-portable-hint = Je index, instellingen en bladwijzers blijven in deze map. Er wordt niets naar deze computer geschreven.
settings-results-natural-sort = Natuurlijke sortering (file2 vóór file10)
menu-search-ignore-punctuation = Leestekens negeren
menu-search-ignore-whitespace = Spaties negeren
regex-builder-title = Bouwer voor reguliere expressies
regex-builder-placeholder = Typ een patroon, bijv. ^rapport-\d+
regex-builder-match-count = { $matched } van { $total } getoonde namen komen overeen
regex-builder-no-results = Zoek eerst iets — de bouwer test je patroon op de namen op het scherm.
regex-builder-cheatsheet = Spiekbriefje
regex-builder-flavor-note = Rust-syntaxis. Geen terugverwijzingen en geen lookaround — de zoekmachine ondersteunt die niet.
regex-builder-use = Dit patroon gebruiken
regex-cheat-any = Eén willekeurig teken
regex-cheat-classes = Cijfer, woordteken, witruimte
regex-cheat-set = Eén uit de set, of geen uit de set
regex-cheat-repeat = Nul of meer, één of meer, optioneel
regex-cheat-count = Precies, minstens, of een bereik
regex-cheat-anchor = Begin en einde van de naam
regex-cheat-alt = Het een of het ander
regex-cheat-inline-flag = Hoofdletters negeren vanaf hier
regex-cheat-noncapturing = Groeperen zonder vast te leggen
regex-cheat-escape = Een speciaal teken escapen
quicklook-title = Snelle weergave
quicklook-position = { $at } van { $total }
quicklook-hint = Pijltjestoetsen lopen door de resultaten · Spatie of Esc sluit
quicklook-open-native = Openen in Snelle weergave van macOS
menu-view-sidebar = Zijbalk
sidebar-title = Zijbalk
sidebar-bookmarks = Bladwijzers
sidebar-filters = Filters
sidebar-volumes = Volumes
sidebar-recent = Recente zoekopdrachten
sidebar-no-bookmarks = Nog geen bladwijzers
sidebar-no-volumes = Geen volumes geïndexeerd
sidebar-no-recent = Nog niets
sidebar-clear-recent = Wissen
menu-tools-permission-health = Rechtenstatus…
permissions-title = Rechtenstatus
permissions-all-clear = Alles wat je Freally liet indexeren was leesbaar.
permissions-summary = { $denied } mappen konden niet worden gelezen omdat toegang werd geweigerd, en { $other } mislukten om andere redenen. Bestanden daarin staan niet in de index en verschijnen niet in de resultaten.
permissions-truncated = Nog { $dropped } zijn geteld maar niet vermeld.
permissions-how-to-fix = Hoe los je dit op
permissions-by-volume = Waar
permissions-group-counts = { $denied } geweigerd · { $other } overig
permissions-macos-granted = Freally heeft al volledige schijftoegang. De mappen hieronder worden door iets anders beschermd — controleer eigenaar en rechten.
permissions-macos-steps = macOS beschermt deze mappen totdat je volledige schijftoegang verleent. Open Privacy en beveiliging → Volledige schijftoegang, zet Freally aan, sluit Freally af en open het opnieuw en scan opnieuw.
permissions-macos-open-settings = Instellingen voor volledige schijftoegang openen
permissions-macos-undetermined = Freally kon niet vaststellen of volledige schijftoegang al is verleend, dus dit is misschien niet het probleem.
permissions-linux-steps = Je gebruiker kan deze paden niet lezen. Controleer eigenaar en modus van de map, of koppel het bestandssysteem met rechten die je account kan doorlopen. Voor systeembrede paden moet de daemon mogelijk met verhoogde rechten draaien.
permissions-windows-steps = Een Windows-toegangsregel weigert je account. Open Eigenschappen → Beveiliging van de map om te zien welke regel geldt, of draai de indexservice als een gebruiker die de map kan lezen.
permissions-generic-steps = Het besturingssysteem weigerde deze paden te lezen. Controleer de rechten.
status-paths-skipped = { $count } mappen overgeslagen
media-open-externally = Openen in de systeemspeler
media-play-pause = Afspelen of pauzeren
media-seek = Zoeken
media-loop = Herhalen
media-volume = Volume
