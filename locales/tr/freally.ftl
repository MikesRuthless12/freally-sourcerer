...
toast-search-failed = Arama başarısız: { $error }
toast-settings-save-failed = Ayarlar kaydedilemedi: { $error }
toast-settings-reset-failed = Varsayılanlar geri yüklenemedi: { $error }
toast-index-root-failed = { $path } dizine eklenemedi: { $error }
menu-help-report-bug = Hata Bildir…
bugreport-title = Hata bildir
bugreport-crash-notice = Freally Sourcerer son çalıştırmada beklenmedik şekilde kapandı. Bununla ilgili anonim bir rapor gönderebilirsiniz.
bugreport-what-happened = Ne oldu?
bugreport-placeholder = Sorun oluştuğunda ne yapıyordunuz?
bugreport-include-crash = Aşağıdaki çökme ayrıntılarını ekle
bugreport-exact-text = Gönderilecek olan tam olarak budur
bugreport-privacy = Hiçbir şey otomatik gönderilmez. Önceden doldurulmuş bir taslak açılır — okuyup kendiniz gönderirsiniz. Rapor yalnızca uygulama sürümünü ve işletim sisteminizi taşır; ana klasörünüz ve kullanıcı adınız kaldırılır.
bugreport-github = GitHub’da konu aç
bugreport-gmail = Gmail’de aç
bugreport-email = E-posta uygulamamda aç
bugreport-copy = Raporu kopyala
bugreport-copied = Kopyalandı.
bugreport-discard-crash = Bu çökme raporunu at
bugreport-opened = Bir taslak açıldı. Okuyun, sonra kendiniz gönderin.
bugreport-failed = Taslak açılamadı: { $error }
logs-crash-drills = Çökme raporu provaları
logs-simulate-crash = Çökme raporunu benzet
logs-force-crash = Test çökmesi zorla ve çık
updates-check-now = Şimdi güncellemeleri denetle
updates-checking = Denetleniyor…
updates-last-checked = Son denetim
updates-never-checked = Hiç
updates-current = En son sürümü ({ $current }) kullanıyorsunuz.
updates-available = { $version } sürümü mevcut. Şu anda { $current } kullanıyorsunuz.
updates-confirm-title = Güncellemeyi kur
updates-confirm-body = Freally Sourcerer { $version } mevcut.\n\nŞu anda { $current } kullanıyorsunuz. Freally Sourcerer’ı kapatıp yeni sürümü şimdi kurmak ister misiniz?
updates-confirm-yes = Evet, kur
updates-confirm-no = Şimdi değil
updates-installing = { $version } indiriliyor ve kuruluyor… Freally Sourcerer kapanacak.
updates-failed = Güncelleme başarısız: { $error }
updates-notes-heading = Yenilikler
...
menu-tools-index-health = Dizin Durumu…
health-title = Dizin durumu
health-loading = Dizin durumu okunuyor…
health-all-good = İzlenen tüm konumlar güncel.
health-no-watched-roots = Henüz hiçbir klasör dizinlenmiyor.
health-col-volume = Konum
health-col-status = Durum
health-col-lag = Gecikme
health-col-last-event = Son değişiklik
health-col-applied = Uygulanan
health-col-dropped = Düşürülen
health-col-queue = Kuyruk
health-status-live = Canlı
health-status-scan-only = Yalnızca tarama
health-lag-value = { $last } ms (tepe { $max } ms)
health-no-events-yet = Henüz değişiklik yok
health-never = Hiç
health-ago = { $secs } sn önce
health-legend = Gecikme, diskteki bir değişiklikten sonuçlarda görünmesine kadar geçen süredir. “Uygulanan” dizinlenen olayları sayar, birleştirilen olaylar parantez içindedir.
health-extraction-untracked = İçerik çıkarma birikimi henüz izlenmiyor.
health-extraction-backlog = İçerik çıkarma birikimi: { $count }
health-fix-rebuild = Dizini yeniden oluştur
health-advice-journal-stream-reset = İşletim sistemi { $root } üzerindeki değişiklik akışını attı. Bu sırada yapılan değişiklikler dizinde yok — yeniden oluşturma onları geri getirir.
health-advice-events-dropped = { $root } üzerinde { $count } değişiklik dizinlenebileceğinden hızlı geldi ve düşürüldü. Yeniden oluşturma onları geri getirir.
...
menu-edit-bulk-rename = Yeniden adlandır…
rename-title = Seçili { $count } öğeyi yeniden adlandır
rename-find = Bul
rename-replace = Şununla değiştir
rename-use-regex = Düzenli ifade
rename-ignore-case = Büyük/küçük harfi yoksay
rename-part = Şuna uygula
rename-part-stem = Uzantısız ad
rename-part-full = Tüm dosya adı
rename-case = Harf durumu
rename-case-none = Değişmedi
rename-case-lower = küçük harf
rename-case-upper = BÜYÜK HARF
rename-case-title = Her Kelime Büyük
rename-counter-start = Sayaç başlangıcı
rename-hint = Sayaç için { "{" }n{ "}" }, doldurmak için { "{" }n:03{ "}" } kullanın. Düzenli ifadelerde $1 bir grup ekler.
rename-col-before = Önce
rename-col-after = Sonra
rename-col-status = Durum
rename-status-ok = Yeniden adlandırılacak
rename-status-unchanged = Değişmedi
rename-status-invalid = Geçersiz ad
rename-status-collision = İki dosya aynı adı alırdı
rename-status-exists = Bu ada sahip bir dosya zaten var
rename-invalid-empty = Ad boş kalırdı
rename-invalid-path-separator = Ad klasör ayıracı içeremez
rename-invalid-dot-name = Ad . veya .. olamaz
rename-invalid-forbidden-character = Ad izin verilmeyen bir karakter içeriyor
rename-invalid-reserved-name = Ad işletim sistemi tarafından ayrılmış
rename-invalid-bad-pattern = Arama deseni geçersiz
rename-summary = { $count } dosya yeniden adlandırılacak.
rename-blocked = Yeniden adlandırmadan önce işaretli satırları düzeltin. O zamana kadar hiçbir şey değişmez.
rename-apply = Yeniden adlandır
rename-toast-done = { $count } dosya yeniden adlandırıldı
rename-nothing-selected = Önce bazı sonuçları seçin.
ops-toast-undone = Geri alındı — { $count } dosya eski haline döndü
ops-toast-redone = Yinelendi — { $count } dosya yeniden adlandırıldı
about-portable-on = Taşınabilir mod açık
about-portable-hint = Dizininiz, ayarlarınız ve yer imleriniz bu klasörde kalır. Bu bilgisayara hiçbir şey yazılmaz.
settings-results-natural-sort = Doğal sıralama (file2, file10 öncesinde)
menu-search-ignore-punctuation = Noktalama işaretlerini yoksay
menu-search-ignore-whitespace = Boşlukları yoksay
regex-builder-title = Düzenli ifade oluşturucu
regex-builder-placeholder = Bir desen yaz, örn. ^rapor-\d+
regex-builder-match-count = Gösterilen { $total } addan { $matched } tanesi eşleşiyor
regex-builder-no-results = Önce bir arama yap — oluşturucu desenini ekrandaki adlarla dener.
regex-builder-cheatsheet = Kopya kâğıdı
regex-builder-flavor-note = Rust söz dizimi. Geri başvuru ve lookaround yok — arama motoru bunları desteklemiyor.
regex-builder-use = Bu deseni kullan
regex-cheat-any = Herhangi bir karakter
regex-cheat-classes = Rakam, sözcük karakteri, boşluk
regex-cheat-set = Kümeden biri ya da kümeden hiçbiri
regex-cheat-repeat = Sıfır veya daha çok, bir veya daha çok, isteğe bağlı
regex-cheat-count = Tam olarak, en az ya da bir aralık
regex-cheat-anchor = Adın başı ve sonu
regex-cheat-alt = Ya biri ya öteki
regex-cheat-inline-flag = Buradan sonra büyük/küçük harfi yoksay
regex-cheat-noncapturing = Yakalamadan grupla
regex-cheat-escape = Özel karakteri kaçır
quicklook-title = Hızlı Bakış
quicklook-position = { $total } içinden { $at }
quicklook-hint = Ok tuşları sonuçlar arasında gezinir · Boşluk veya Esc kapatır
quicklook-open-native = macOS Hızlı Bakış’ta aç
menu-view-sidebar = Kenar çubuğu
sidebar-title = Kenar çubuğu
sidebar-bookmarks = Yer imleri
sidebar-filters = Filtreler
sidebar-volumes = Birimler
sidebar-recent = Son aramalar
sidebar-no-bookmarks = Henüz yer imi yok
sidebar-no-volumes = Dizinlenmiş birim yok
sidebar-no-recent = Henüz bir şey yok
sidebar-clear-recent = Temizle
menu-tools-permission-health = İzin durumu…
permissions-title = İzin durumu
permissions-all-clear = Freally'den dizinlemesini istediğiniz her şey okunabildi.
permissions-summary = Erişim reddedildiği için { $denied } klasör okunamadı, { $other } klasör ise başka nedenlerle başarısız oldu. İçlerindeki dosyalar dizinde değil ve sonuçlarda görünmeyecek.
permissions-truncated = { $dropped } tanesi daha sayıldı ama listelenmedi.
permissions-how-to-fix = Bu nasıl düzeltilir
permissions-by-volume = Nerede
permissions-group-counts = { $denied } reddedildi · { $other } diğer
permissions-macos-granted = Freally'nin zaten Tam Disk Erişimi var. Aşağıdaki klasörler başka bir şey tarafından korunuyor — sahipliklerini ve izinlerini kontrol edin.
permissions-macos-steps = Tam Disk Erişimi vermediğiniz sürece macOS bu klasörleri korur. Gizlilik ve Güvenlik → Tam Disk Erişimi'ni açın, Freally'yi etkinleştirin, Freally'den çıkıp yeniden açın ve yeniden tarayın.
permissions-macos-open-settings = Tam Disk Erişimi ayarlarını aç
permissions-macos-undetermined = Freally, Tam Disk Erişimi'nin zaten verilip verilmediğini belirleyemedi; sorun bu olmayabilir.
permissions-linux-steps = Kullanıcınız bu yolları okuyamıyor. Klasörün sahibini ve modunu kontrol edin ya da dosya sistemini hesabınızın geçebileceği izinlerle bağlayın. Sistem genelindeki yolları dizinlemek, arka plan hizmetinin yükseltilmiş ayrıcalıklarla çalışmasını gerektirebilir.
permissions-windows-steps = Bir Windows erişim kuralı hesabınızı reddediyor. Hangi kuralın geçerli olduğunu görmek için klasörün Özellikler → Güvenlik bölümünü açın ya da dizin hizmetini okuyabilen bir kullanıcı olarak çalıştırın.
permissions-generic-steps = İşletim sistemi bu yolları okumayı reddetti. İzinlerini kontrol edin.
status-paths-skipped = { $count } klasör atlandı
media-open-externally = Sistem oynatıcısında aç
media-play-pause = Oynat veya duraklat
