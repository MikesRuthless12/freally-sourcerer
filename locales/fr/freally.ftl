...
toast-search-failed = Échec de la recherche : { $error }
toast-settings-save-failed = Impossible d’enregistrer les paramètres : { $error }
toast-settings-reset-failed = Impossible de rétablir les valeurs par défaut : { $error }
toast-index-root-failed = Impossible d’ajouter { $path } à l’index : { $error }
menu-help-report-bug = Signaler un problème…
bugreport-title = Signaler un problème
bugreport-crash-notice = Freally Sourcerer s’est fermé de façon inattendue lors de la dernière exécution. Vous pouvez envoyer un rapport anonyme à ce sujet.
bugreport-what-happened = Que s’est-il passé ?
bugreport-placeholder = Que faisiez-vous au moment du problème ?
bugreport-include-crash = Inclure les détails du plantage ci-dessous
bugreport-exact-text = Voici exactement ce qui sera envoyé
bugreport-privacy = Rien n’est envoyé automatiquement. Un brouillon pré-rempli s’ouvre — vous le lisez et l’envoyez vous-même. Le rapport ne contient que la version de l’application et votre système ; votre dossier personnel et votre nom d’utilisateur sont supprimés.
bugreport-github = Ouvrir un ticket GitHub
bugreport-gmail = Ouvrir dans Gmail
bugreport-email = Ouvrir dans mon application de messagerie
bugreport-copy = Copier le rapport
bugreport-copied = Copié.
bugreport-discard-crash = Abandonner ce rapport de plantage
bugreport-opened = Un brouillon est ouvert. Lisez-le, puis envoyez-le vous-même.
bugreport-failed = Impossible d’ouvrir le brouillon : { $error }
logs-crash-drills = Exercices de rapport de plantage
logs-simulate-crash = Simuler un rapport de plantage
logs-force-crash = Forcer un plantage de test et quitter
updates-check-now = Rechercher des mises à jour
updates-checking = Vérification…
updates-last-checked = Dernière vérification
updates-never-checked = Jamais
updates-current = Vous utilisez la dernière version ({ $current }).
updates-available = La version { $version } est disponible. Vous utilisez { $current }.
updates-confirm-title = Installer la mise à jour
updates-confirm-body = Freally Sourcerer { $version } est disponible.\n\nVous utilisez { $current }. Voulez-vous fermer Freally Sourcerer et installer la nouvelle version maintenant ?
updates-confirm-yes = Oui, installer
updates-confirm-no = Pas maintenant
updates-installing = Téléchargement et installation de { $version }… Freally Sourcerer va se fermer.
updates-failed = Échec de la mise à jour : { $error }
updates-notes-heading = Nouveautés
...
did-you-mean-label = Vouliez-vous dire
menu-search-match-phonetic = Correspondance phonétique CJC

# SRC-M13 — Index Health panel + rebuild advisor
menu-tools-index-health = État de l’index…
health-title = État de l’index
health-loading = Lecture de l’état de l’index…
health-all-good = Tous les emplacements surveillés sont à jour.
health-no-watched-roots = Aucun dossier n’est encore indexé.
health-col-volume = Emplacement
health-col-status = État
health-col-lag = Latence
health-col-last-event = Dernier changement
health-col-applied = Appliqués
health-col-dropped = Perdus
health-col-queue = File
health-status-live = En direct
health-status-scan-only = Analyse seule
health-lag-value = { $last } ms (pic { $max } ms)
health-no-events-yet = Aucun changement
health-never = Jamais
health-ago = il y a { $secs } s
health-legend = La latence est le délai entre un changement sur le disque et son apparition dans les résultats. « Appliqués » compte les événements indexés, les événements fusionnés entre parenthèses.
health-extraction-untracked = La file d’extraction de contenu n’est pas encore suivie.
health-extraction-backlog = File d’extraction de contenu : { $count }
health-fix-rebuild = Reconstruire l’index
health-advice-journal-stream-reset = Le système d’exploitation a supprimé le flux de changements de { $root }. Les changements survenus entre-temps manquent à l’index — une reconstruction les rétablit.
health-advice-events-dropped = { $count } changements sur { $root } sont arrivés plus vite qu’ils ne pouvaient être indexés et ont été perdus. Une reconstruction les rétablit.
health-advice-not-monitoring = Les changements sur { $root } ne sont pas suivis : les résultats ne se mettent à jour qu’après une nouvelle analyse.
health-advice-high-lag = Les changements sur { $root } mettent jusqu’à { $count } ms à apparaître dans les résultats.
health-advice-queue-saturated = La file de changements de { $root } est presque pleine ({ $count } en attente) ; des changements risquent d’être perdus.

# SRC-M14 — offline removable-volume catalogs
results-offline-badge = hors ligne — { $name }
results-offline-badge-title = Le disque contenant ce fichier n’est pas connecté. L’entrée provient du catalogue que Freally conserve de cet appareil.

# SRC-M15 bulk rename + SRC-M16 undo/redo
menu-edit-undo = Annuler
menu-edit-redo = Rétablir
menu-edit-bulk-rename = Renommer…
rename-title = Renommer { $count } éléments
rename-find = Rechercher
rename-replace = Remplacer par
rename-use-regex = Expression régulière
rename-ignore-case = Ignorer la casse
rename-part = Appliquer à
rename-part-stem = Nom sans extension
rename-part-full = Nom complet
rename-case = Casse
rename-case-none = Inchangée
rename-case-lower = minuscules
rename-case-upper = MAJUSCULES
rename-case-title = Casse De Titre
rename-counter-start = Compteur à partir de
rename-hint = Utilisez { "{" }n{ "}" } pour un compteur, { "{" }n:03{ "}" } pour le compléter. Avec les expressions régulières, $1 insère un groupe.
rename-col-before = Avant
rename-col-after = Après
rename-col-status = État
rename-status-ok = Sera renommé
rename-status-unchanged = Inchangé
rename-status-invalid = Nom invalide
rename-status-collision = Deux fichiers auraient le même nom
rename-status-exists = Un fichier porte déjà ce nom
rename-invalid-empty = Le nom serait vide
rename-invalid-path-separator = Le nom ne peut pas contenir de séparateur de dossier
rename-invalid-dot-name = Le nom ne peut pas être . ou ..
rename-invalid-forbidden-character = Le nom contient un caractère interdit
rename-invalid-reserved-name = Le nom est réservé par le système
rename-invalid-bad-pattern = Le motif de recherche est invalide
rename-summary = { $count } fichiers seront renommés.
rename-blocked = Corrigez les lignes signalées avant de renommer. Rien n’est modifié entre-temps.
rename-apply = Renommer
rename-toast-done = { $count } fichiers renommés
rename-nothing-selected = Sélectionnez d’abord des résultats.
ops-toast-undone = Annulé — { $count } fichiers restaurés
ops-toast-redone = Rétabli — { $count } fichiers renommés à nouveau
about-portable-on = Le mode portable est activé
about-portable-hint = Votre index, vos réglages et vos favoris restent dans ce dossier. Rien n'est écrit sur cet ordinateur.
settings-results-natural-sort = Tri naturel (file2 avant file10)
menu-search-ignore-punctuation = Ignorer la ponctuation
menu-search-ignore-whitespace = Ignorer les espaces
regex-builder-title = Constructeur d’expressions régulières
regex-builder-placeholder = Saisis un motif, par ex. ^rapport-\d+
regex-builder-match-count = { $matched } noms sur { $total } affichés correspondent
regex-builder-no-results = Lance d’abord une recherche : le constructeur teste ton motif sur les noms affichés.
regex-builder-cheatsheet = Aide-mémoire
regex-builder-flavor-note = Syntaxe Rust. Ni rétroréférences ni assertions arrière — le moteur de recherche ne les gère pas.
regex-builder-use = Utiliser ce motif
regex-cheat-any = N’importe quel caractère
regex-cheat-classes = Chiffre, caractère de mot, espace
regex-cheat-set = Un de l’ensemble, ou aucun de l’ensemble
regex-cheat-repeat = Zéro ou plus, un ou plus, facultatif
regex-cheat-count = Exactement, au moins, ou un intervalle
regex-cheat-anchor = Début et fin du nom
regex-cheat-alt = L’un ou l’autre
regex-cheat-inline-flag = Ignorer la casse à partir d’ici
regex-cheat-noncapturing = Grouper sans capturer
regex-cheat-escape = Échapper un caractère spécial
quicklook-title = Coup d’œil
quicklook-position = { $at } sur { $total }
quicklook-hint = Les flèches parcourent les résultats · Espace ou Échap ferme
quicklook-open-native = Ouvrir dans Coup d’œil (macOS)
...
sidebar-recent = Recherches récentes
sidebar-no-bookmarks = Aucun favori pour le moment
sidebar-no-volumes = Aucun volume indexé
sidebar-no-recent = Rien pour le moment
sidebar-clear-recent = Effacer
menu-tools-permission-health = État des autorisations…
permissions-title = État des autorisations
permissions-all-clear = Tout ce que vous avez demandé à Freally d'indexer était lisible.
permissions-summary = { $denied } dossiers n'ont pas pu être lus (accès refusé) et { $other } ont échoué pour d'autres raisons. Les fichiers qu'ils contiennent ne sont pas indexés et n'apparaîtront pas dans les résultats.
permissions-truncated = { $dropped } autres ont été comptés mais ne sont pas listés.
permissions-how-to-fix = Comment corriger
permissions-by-volume = Où
permissions-group-counts = { $denied } refusés · { $other } autres
permissions-macos-granted = Freally dispose déjà de l'accès complet au disque. Les dossiers ci-dessous sont protégés par autre chose — vérifiez leur propriétaire et leurs autorisations.
permissions-macos-steps = macOS protège ces dossiers tant que vous n'accordez pas l'accès complet au disque. Ouvrez Confidentialité et sécurité → Accès complet au disque, activez Freally, quittez puis rouvrez Freally et relancez une analyse.
permissions-macos-open-settings = Ouvrir les réglages d'accès complet au disque
permissions-macos-undetermined = Freally n'a pas pu déterminer si l'accès complet au disque est déjà accordé ; ce n'est donc peut-être pas la cause.
permissions-linux-steps = Votre utilisateur ne peut pas lire ces chemins. Vérifiez le propriétaire et le mode du dossier, ou montez le système de fichiers avec des droits que votre compte peut traverser. Indexer des chemins système peut exiger que le démon s'exécute avec des privilèges élevés.
permissions-windows-steps = Une règle d'accès Windows refuse votre compte. Ouvrez Propriétés → Sécurité du dossier pour voir la règle applicable, ou exécutez le service d'index sous un utilisateur autorisé à le lire.
permissions-generic-steps = Le système d'exploitation a refusé de lire ces chemins. Vérifiez leurs autorisations.
status-paths-skipped = { $count } dossiers ignorés
media-open-externally = Ouvrir dans le lecteur système
media-play-pause = Lire ou mettre en pause
