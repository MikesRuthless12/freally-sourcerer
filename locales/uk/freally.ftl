...
backup-confirm-import-commands = Цей файл налаштувань додає користувацькі команди, які можуть запускати програми на вашому комп'ютері: { $programs }. Імпортувати їх?
...
toast-search-failed = Помилка пошуку: { $error }
toast-settings-save-failed = Не вдалося зберегти налаштування: { $error }
toast-settings-reset-failed = Не вдалося відновити типові значення: { $error }
toast-index-root-failed = Не вдалося додати { $path } до індексу: { $error }
menu-help-report-bug = Повідомити про ваду…
bugreport-title = Повідомити про ваду
bugreport-crash-notice = Минулого разу Freally Sourcerer завершився несподівано. Ви можете надіслати анонімний звіт про це.
bugreport-what-happened = Що сталося?
bugreport-placeholder = Що ви робили, коли виникла проблема?
bugreport-include-crash = Долучити наведені нижче відомості про збій
bugreport-exact-text = Саме це й буде надіслано
bugreport-privacy = Нічого не надсилається автоматично. Відкриється заповнений чернетковий лист — ви прочитаєте його й надішлете самі. Звіт містить лише версію застосунку та вашу ОС; домашню теку й ім’я користувача вилучено.
bugreport-github = Відкрити issue на GitHub
bugreport-gmail = Відкрити у Gmail
bugreport-email = Відкрити в поштовому застосунку
bugreport-copy = Скопіювати звіт
bugreport-copied = Скопійовано.
bugreport-discard-crash = Відхилити цей звіт про збій
bugreport-opened = Чернетку відкрито. Прочитайте її та надішліть самі.
bugreport-failed = Не вдалося відкрити чернетку: { $error }
logs-crash-drills = Перевірки звіту про збій
logs-simulate-crash = Змоделювати звіт про збій
logs-force-crash = Примусово спричинити тестовий збій і вийти
updates-check-now = Перевірити оновлення зараз
updates-checking = Перевірка…
updates-last-checked = Востаннє перевірено
updates-never-checked = Ніколи
updates-current = У вас найновіший випуск ({ $current }).
updates-available = Доступна версія { $version }. У вас { $current }.
updates-confirm-title = Встановити оновлення
updates-confirm-body = Доступний Freally Sourcerer { $version }.\n\nУ вас { $current }. Закрити Freally Sourcerer і встановити нову версію зараз?
updates-confirm-yes = Так, встановити
updates-confirm-no = Не зараз
updates-installing = Завантаження та встановлення { $version }… Freally Sourcerer буде закрито.
updates-failed = Не вдалося оновити: { $error }
updates-notes-heading = Що нового
...
did-you-mean-label = Можливо, ви мали на увазі
menu-search-match-phonetic = Зіставляти фонетику CJK

# SRC-M13 — Index Health panel + rebuild advisor
menu-tools-index-health = Стан індексу…
health-title = Стан індексу
health-loading = Читання стану індексу…
health-all-good = Усі відстежувані розташування актуальні.
health-no-watched-roots = Жодна тека ще не індексується.
health-col-volume = Розташування
health-col-status = Стан
health-col-lag = Затримка
health-col-last-event = Остання зміна
health-col-applied = Застосовано
health-col-dropped = Втрачено
health-col-queue = Черга
health-status-live = У реальному часі
health-status-scan-only = Лише сканування
health-lag-value = { $last } мс (пік { $max } мс)
health-no-events-yet = Змін ще немає
health-never = Ніколи
health-ago = { $secs } с тому
health-legend = Затримка — це час від зміни на диску до її появи в результатах. «Застосовано» рахує проіндексовані події, об’єднані події — у дужках.
health-extraction-untracked = Черга видобування вмісту ще не відстежується.
health-extraction-backlog = Черга видобування вмісту: { $count }
health-fix-rebuild = Перебудувати індекс
health-advice-journal-stream-reset = Операційна система відкинула потік змін на { $root }. Зміни за цей час відсутні в індексі — перебудова їх поверне.
health-advice-events-dropped = { $count } змін на { $root } надійшли швидше, ніж їх можна було проіндексувати, і були втрачені. Перебудова їх поверне.
...
menu-edit-bulk-rename = Перейменувати…
rename-title = Перейменувати { $count } вибраних
rename-find = Знайти
rename-replace = Замінити на
rename-use-regex = Регулярний вираз
rename-ignore-case = Ігнорувати регістр
rename-part = Застосувати до
rename-part-stem = Ім’я без розширення
rename-part-full = Усе ім’я файлу
rename-case = Регістр
rename-case-none = Без змін
rename-case-lower = нижній регістр
rename-case-upper = ВЕРХНІЙ РЕГІСТР
rename-case-title = Кожне Слово З Великої
rename-counter-start = Лічильник від
rename-hint = { "{" }n{ "}" } вставляє лічильник, { "{" }n:03{ "}" } доповнює його нулями. З регулярними виразами $1 вставляє групу.
rename-col-before = До
rename-col-after = Після
rename-col-status = Стан
rename-status-ok = Буде перейменовано
rename-status-unchanged = Без змін
rename-status-invalid = Неприпустиме ім’я
rename-status-collision = Два файли матимуть однакове ім’я
rename-status-exists = Файл із таким ім’ям уже існує
rename-invalid-empty = Ім’я буде порожнім
rename-invalid-path-separator = Ім’я не може містити роздільник тек
rename-invalid-dot-name = Ім’я не може бути . або ..
rename-invalid-forbidden-character = Ім’я містить неприпустимий символ
rename-invalid-reserved-name = Ім’я зарезервовано операційною системою
rename-invalid-bad-pattern = Шаблон пошуку неприпустимий
rename-summary = Буде перейменовано { $count } файлів.
rename-blocked = Виправте позначені рядки перед перейменуванням. До того нічого не зміниться.
rename-apply = Перейменувати
rename-toast-done = Перейменовано { $count } файлів
rename-nothing-selected = Спершу виберіть результати.
ops-toast-undone = Скасовано — повернуто { $count } файлів
ops-toast-redone = Повторено — знову перейменовано { $count } файлів
about-portable-on = Портативний режим увімкнено
about-portable-hint = Індекс, налаштування та закладки залишаються в цій теці. На цей комп'ютер нічого не записується.
settings-results-natural-sort = Природне сортування (file2 перед file10)
menu-search-ignore-punctuation = Ігнорувати пунктуацію
menu-search-ignore-whitespace = Ігнорувати пробіли
regex-builder-title = Конструктор регулярних виразів
regex-builder-placeholder = Введіть шаблон, наприклад ^звіт-\d+
regex-builder-match-count = Збігається { $matched } з { $total } показаних імен
regex-builder-no-results = Спершу виконайте пошук — конструктор перевіряє шаблон на іменах з екрана.
regex-builder-cheatsheet = Шпаргалка
regex-builder-flavor-note = Синтаксис Rust. Без зворотних посилань і без lookaround — пошуковий рушій їх не підтримує.
regex-builder-use = Використати цей шаблон
regex-cheat-any = Будь-який один символ
regex-cheat-classes = Цифра, символ слова, пробіл
regex-cheat-set = Один із набору або жоден із набору
regex-cheat-repeat = Нуль або більше, один або більше, необовʼязково
regex-cheat-count = Рівно, щонайменше або діапазон
regex-cheat-anchor = Початок і кінець імені
regex-cheat-alt = Одне або інше
regex-cheat-inline-flag = Далі ігнорувати регістр
regex-cheat-noncapturing = Групувати без захоплення
regex-cheat-escape = Екранувати спеціальний символ
quicklook-title = Швидкий перегляд
quicklook-position = { $at } з { $total }
quicklook-hint = Стрілки гортають результати · Пробіл або Esc закриває
quicklook-open-native = Відкрити у Швидкому перегляді macOS
menu-view-sidebar = Бічна панель
sidebar-title = Бічна панель
sidebar-bookmarks = Закладки
sidebar-filters = Фільтри
sidebar-volumes = Томи
sidebar-recent = Нещодавні запити
sidebar-no-bookmarks = Закладок ще немає
sidebar-no-volumes = Немає проіндексованих томів
sidebar-no-recent = Поки порожньо
sidebar-clear-recent = Очистити
menu-tools-permission-health = Стан доступу…
permissions-title = Стан доступу
permissions-all-clear = Усе, що ви попросили проіндексувати, вдалося прочитати.
permissions-summary = { $denied } тек не вдалося прочитати через відмову в доступі, ще { $other } не вдалося з інших причин. Файли в них не потрапили до індексу й не зʼявляться в результатах.
permissions-truncated = Ще { $dropped } враховано, але не показано.
permissions-how-to-fix = Як це виправити
permissions-by-volume = Де
permissions-group-counts = { $denied } відмов · { $other } інших
permissions-macos-granted = Freally уже має повний доступ до диска. Теки нижче захищені чимось іншим — перевірте власника та права.
permissions-macos-steps = macOS захищає ці теки, доки ви не надасте повний доступ до диска. Відкрийте «Конфіденційність і безпека» → «Повний доступ до диска», увімкніть Freally, закрийте та знову відкрийте Freally і проскануйте ще раз.
permissions-macos-open-settings = Відкрити налаштування повного доступу до диска
permissions-macos-undetermined = Freally не зміг визначити, чи вже надано повний доступ до диска, тож причина може бути інша.
permissions-linux-steps = Ваш користувач не може прочитати ці шляхи. Перевірте власника та режим теки або змонтуйте файлову систему з правами, через які ваш обліковий запис може пройти. Для системних шляхів службі може знадобитися запуск з підвищеними правами.
permissions-windows-steps = Правило доступу Windows забороняє вашому обліковому запису. Відкрийте «Властивості» → «Безпека» теки, щоб побачити правило, або запустіть службу індексування від імені користувача, який може її читати.
permissions-generic-steps = Операційна система відмовилася читати ці шляхи. Перевірте їхні права.
status-paths-skipped = пропущено тек: { $count }
media-open-externally = Відкрити в системному програвачі
media-play-pause = Відтворити або пауза
media-seek = Перемотати
media-loop = Повтор
media-volume = Гучність
