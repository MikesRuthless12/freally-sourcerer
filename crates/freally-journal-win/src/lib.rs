//! Windows NTFS USN journal subscriber for Freally (Phase 1).
//!
//! Public surface (mirrored later by `freally-journal-mac` in Phase 2 and
//! `freally-journal-lin` in Phase 3):
//!
//! ```ignore
//! use freally_journal_win::{open, JournalEvent};
//! use std::path::Path;
//! use futures::StreamExt;
//!
//! # async fn demo() -> Result<(), freally_journal_win::JournalError> {
