...
pub struct ParseOpts {
    ...
    ///
    /// Freally-only modifiers in this mode surface as
    /// [`ParseError::StrictEverythingViolation`]. Phase 11's UI
    /// surfaces this so a user can paste a Freally query into a
...
fn parse_modifier(
    ...
    // Strict-everything: reject Freally-only modifiers up-front so
