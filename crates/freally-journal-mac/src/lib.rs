//! macOS FSEvents journal subscriber for Freally (Phase 2).
//!
//! Public surface mirrors `freally-journal-win` so the facade in
//! `freally-journal` re-exports the same shape on every OS:
//!
//! ```ignore
//! use freally_journal_mac::{open, JournalEvent};
//! use std::path::Path;
//! use futures::StreamExt;
//!
//! # async fn demo() -> Result<(), freally_journal_mac::JournalError> {
