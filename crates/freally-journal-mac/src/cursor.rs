...
//! `~/Library/Application Support/Freally/cursors/<root_hash>.json`.
//!
...
impl StreamCursor {
    /// Default cursor root: `~/Library/Application Support/Freally/cursors`.
    /// Falls back to `<system_temp>/Freally/cursors` if `HOME` is unset
