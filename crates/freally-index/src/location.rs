...
//!
//! Windows: `%LOCALAPPDATA%\Freally\index`
//! macOS:   `~/Library/Application Support/Freally/index`
//! Linux:   `${XDG_DATA_HOME:-~/.local/share}/freally/index`
//!
...
/// Windows this is `%PROGRAMDATA%\Freally\index` (typically
/// `C:\ProgramData\Freally\index`) — writeable by SYSTEM, readable
